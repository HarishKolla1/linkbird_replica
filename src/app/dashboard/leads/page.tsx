      ...
      <Card>
        ...
        <CardContent className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead onClick={() => handleSort("name")} className="cursor-pointer w-[25%]">
                  Name {sortBy === "name" ? (sortOrder === "asc" ? "↑" : "↓") : ""}
                </TableHead>
                <TableHead onClick={() => handleSort("campaign")} className="cursor-pointer w-[25%]">
                  Campaign {sortBy === "campaign" ? (sortOrder === "asc" ? "↑" : "↓") : ""}
                </TableHead>
                <TableHead onClick={() => handleSort("status")} className="cursor-pointer w-[25%]">
                  Activity {sortBy === "status" ? (sortOrder === "asc" ? "↑" : "↓") : ""}
                </TableHead>
                <TableHead onClick={() => handleSort("lastContactDate")} className="cursor-pointer w-[25%]">
